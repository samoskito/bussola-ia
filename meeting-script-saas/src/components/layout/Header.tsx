      ...
      <div style={{ display: 'flex', alignItems: 'center' }}>
        ...
        >
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M4 6H20" stroke="#FF6B00" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            <path d="M4 12H20" stroke="#FF6B00" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            <path d="M4 18H20" stroke="#FF6B00" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
        </button>
        ...
        <div style={{ 
          ...
          <span style={{ color: '#FF6B00', fontWeight: 'bold' }}>Bússola Executiva</span>
        </div>
      </div>
