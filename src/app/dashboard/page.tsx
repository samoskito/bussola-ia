            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {AGENTS.map((agent) => {
                ...
                >
                  ...
                  {agent.adminOnly && isAdmin && (
                    <div className="absolute right-4 top-4 rounded-full border border-emerald-500/40 bg-emerald-500/10 px-3 py-1 text-xs font-semibold text-emerald-300">
                      ADMIN
                    </div>
                  )}
