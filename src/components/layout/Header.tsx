    ...
    <header className="relative z-50 flex items-center justify-between p-3 md:p-4 bg-gray-900 border-b border-gray-800 shadow-md w-full h-[80px]">
      ...
      <div className="flex items-center space-x-4">
        <Link 
          ...
          className="flex items-center gap-2 px-3 py-2 text-sm font-medium text-gray-300 rounded-lg hover:bg-gray-800 hover:text-white transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-900 focus:ring-primary-500"
          title="Configurações"
        >
